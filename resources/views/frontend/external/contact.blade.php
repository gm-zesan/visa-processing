...
@section('content')
    @if(session('success'))
        <div style="position: fixed; top: -20px; left: 50%; transform: translate(-50%, -50%); background-image: linear-gradient(to right, #bba574, #967e4a); color: #fff; padding: 5px 15px; border-radius: 5px; display: flex; align-items: center; gap: 10px; opacity: 0" id="success-message">
...
<section class="contact-wrapper" style="background-image: url({{asset(getSettingsData('contact-details', 'image_1'))}});">
    <div class="container">
...
<section class="contact-form-wrapper">
    <div class="container">
        ...
        <div class="location-and-form">
            <div class="map">
                <iframe src="{{getSettingsData('contact-details', 'iframe_link')}}" width="100%" height="590" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            ...
            <div class="form-div">
                ...
                <form action="{{route('message.store')}}" method="POST">
                    ...
                    <div>
                        <textarea name="message" cols="30" required placeholder="Write Your Message Here....."></textarea>
                    </div>
