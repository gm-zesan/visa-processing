                    ...
                    <div class="home_wrapper"
                        ...
                        <div class="container">
                            ...
                            <div class="dit-button mt_20">
                                <a href="{{ $item->button_link }}">{{ $item->button_text }} <i class="fa-solid fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container news_container">
        ...
        <div class="row">
            <div class="col-lg-4 securce_top mt_50">
                ...
                <div class="dit-button mt_20">
                    <a href="{{ getSettingsData('13', 'button_link') }}">{{ getSettingsData('13', 'button_text') }}<i class="fa-solid fa-angle-right"></i></a>
                </div>
            </div>
                    ...
                    <div class="swiper-slide">
                            ...
                            <img src="{{ asset($item->image) }}" alt="img">
                                <div class="choose_country_cont">
                                    <h2>{{ $item->title }}</h2>
                                    {!! $item->description !!}</p>
                                    <a href="{{ $item->button_link }}" class="read_btn_2">{{ $item->button_text }}</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="swiper-slide">
                        <div class="choose_country_card">
                            ...
                            <div class="choose_country_cont">
                                ...
                                <a href="{{route('country',['id'=>$countryVisa->id])}}" class="read_btn">Read More</a>
                            </div>
                        </div>
                    </div>
                @endforeach
                        ...
                        <div class="swiper-slide">
                            <div class="resources_card">
                                ...
                                <div class="resources_cont">
                                    ...
                                    <a href="{{route('single_blog', ['slug'=>$blog->slug])}}" class="read_btn">Read More<i class="fa-solid fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
