                        ...
                        <div class="card-body custom-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="tab-content mt-3" id="langTabContent">
                                        <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="english-tab">
                                            ...
                                            <input type="text" class="form-control custom-input" name="name" placeholder="Category name">
                                            @if($errors->has('name'))
                                                <div class="error_msg">
                                                    {{ $errors->first('name') }}
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="bangla" role="tabpanel" aria-labelledby="bangla-tab">
                                            ...
                                            <input type="text" class="form-control custom-input" name="name_bn" placeholder="Category name (Bangla)">
                                        </div>
                                    </div>
                                </div>
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input" rows="5" name="description" placeholder="Description" style="resize: none;"></textarea>
