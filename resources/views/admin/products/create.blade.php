                        ...
                        <div class="card-body custom-form">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control custom-input" name="name" placeholder="product name" id="name">
                                    @if($errors->has('name'))
                                        <div class="error_msg">
                                            {{ $errors->first('name') }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" class="form-control custom-input" name="price" placeholder="Price" id="price">
                                    @if($errors->has('price'))
                                        <div class="error_msg">
                                            {{ $errors->first('price') }}
                                        </div>
