...
<div class="container-fluid my-3">
    <form action="{{ route('theme.update', ['id' => $theme->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row g-4">
            <div class="col-md-8 col-12">
                <div class="card table-card">
                    ...
                    <div class="card-body custom-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="" class="form-label custom-label">Theme Name</label>
                                <input type="text" class="form-control custom-input" name="name" value="{{$theme->name}}">
                                @if($errors->has('name'))
                                    <div class="error_msg">
                                        {{ $errors->first('name') }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control custom-input" name="subtitle" value="{{$theme->subtitle}}">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control custom-input" name="description" id="description" rows="5"  placeholder="Description"  style="resize: none; height: auto">{{$theme->description}}</textarea>
            ...
            <div class="col-md-4 col-12">
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        <div class="card table-card">
                            <div class="table-header">
                                <div class="table-title">Theme Image</div>
                            </div>
                            <div class="custom-form card-body">
                                <div class="image-select-file">
                                    <label class="form-label custom-label" for="cover_image">
                                        ...
                                        <div class="user-image">
                                            <img id="cover_imagePreview" src="{{ $theme->image ? asset($theme->image) : asset('admin/assets/images/default.jpg') }}" alt="image" class="image-preview">
