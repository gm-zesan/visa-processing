...
<div class="container-fluid my-3">
    <form action="{{ route('country.update', ['id' => $countryDetails->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select custom-input" name="country_id">
                                    ...
                                    @foreach($countries as $country)
                                        <option value="{{$country->id}}" {{ $countryDetails->country_id == $country->id ? 'selected' : '' }}>{{$country->name}}</option>
                                    @endforeach
                                </select>
            ...
            <div class="col-md-4 col-12">
                <div class="row g-4">
                    ...
                    <div class="col-md-12">
                        <div class="card table-card">
                            <div class="table-header">
                                <div class="table-title">Country Image</div>
                            </div>
                            <div class="custom-form card-body">
                                <div class="image-select-file">
                                    <label class="form-label custom-label" for="cover_image">
                                        ...
                                        <div class="user-image">
                                            <img id="cover_imagePreview" src="{{ $countryDetails->image ? asset($countryDetails->image) : asset('admin/assets/images/default.jpg') }}" alt="image" class="image-preview">
