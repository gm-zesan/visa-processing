...
<head>
    ...
    <title>Sign In &mdash; {{ getSettingsData('1', 'title') ? 'AL FAHIM INTERNATIONAL' : 'VisaDocs' }}</title>
    ...
    <style>
        :root {
            --brand-gold: #C59A27;
            --brand-gold-hover: #A87F17;
            --brand-gold-glow: rgba(197, 154, 39, 0.2);
            --brand-navy: #111A3A;
            --text-body: #475569;
            --border-color: #E2E8F0;
            --bg-page: #F8FAFC;
        ...
        * {
        ...
        .btn-submit-login {
            ...
            justify-content: center;
            gap: 0.5rem;
            box-shadow: 0 4px 12px rgba(197, 154, 39, 0.2);
            transition: background-color 0.15s ease, box-shadow 0.15s ease, transform 0.1s ease;
        }

        .btn-submit-login:hover {
            background-color: var(--brand-gold-hover);
            box-shadow: 0 6px 14px rgba(197, 154, 39, 0.28);
        }
...
<div class="login-wrapper">
    <div class="login-card">
        <!-- Logo -->
        <a href="{{ route('home') }}" class="login-logo-wrap" title="AL FAHIM INTERNATIONAL">
            <img src="{{ asset(getSettingsData('5', 'image') ?? 'images/theme_logo.png') }}" 
